 ...
 */
exports.Cs.prototype.disasm_iter = function (buffer, addr) { //(iter, callback) {
    // TODO
    ...
    // var insn = ref.alloc(new ArrayType(InsnType));
    var insn = capstone.cs_malloc(cshandle);
    console.log("Cs.prototype.disasm_iter insn: ", insn);

    var code_ref = buffer.ref();
    console.log("Cs.prototype.disasm_iter code_ref: ", code_ref);
    var code_size_ref = ref.alloc(ref.types.size_t, buffer.length);
    console.log("Cs.prototype.disasm_iter code_size_ref: ", code_size_ref);
    var address_ref = ref.alloc(ref.types.long, addr);
    console.log("Cs.prototype.disasm_iter address_ref: ", address_ref);
